    ...
    <section className="max-w-[1440px] container mx-auto">
      <div className="p-5 relative overflow-hidden">
        ...
        <div className="py-8 flex flex-col items-center justify-center gap-12">
          <h1 className="text-[24px] font-medium sm:text-[36px] font-montserrat text-center lg:text-[40px] text-[#4A4A68]">
            How It Works
          </h1>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 px-5 mx-auto w-full gap-5">
            ...
            <div className="flex flex-col gap-5 items-center justify-start text-center font-inter">
              ...
              <p className="text-[#3a4f39]">
                Immerse yourself in the dynamic Community Cosmos, where
                innovation thrives and connections flourish. Engage with
                like-minded cosmic explorers, share insights, and fuel the
            ...
            <div className="flex flex-col gap-5 items-center justify-start text-center font-inter">
              ...
              <p className="text-[#3a4f39] ">
                ...
                treasures adorned with the TeckTick insignia. Elevate your
                cosmic style with exclusive merchandise that celebrates your
